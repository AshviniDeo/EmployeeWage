...
public class CompanyEmpWage implements EmployeWageBuilder{
	String company;
	int empWage;

	public CompanyEmpWage(String company, int empWage) {
		super();
	...
	public String toString() {
		return "CompanyEmpWage [company=" + company + ", empWage=" + empWage + "]";
	}
	...
	public static void display(EmployeWageBuilder[] build) {
	...
	public static void main(String[] args) {
		...
		EmployeWageBuilder[] build = new EmployeWageBuilder[number];
		int choose = 0;
		while (choose != 1) {
